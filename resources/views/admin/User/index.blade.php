                        ...
                        <tr>
                            ...
                            <td>{{ $users->name }}</td>
                                ...
                                <td><img style="border-radius: 44px;width: 70px;
                                        " src="{{ asset($users->image) }}" class="user-image" alt="User Image" />
                                </td>


                            <td>{{ $users->email }}</td>

                            <td><a href="{{ url('user_edit/' . $users->id) }}" class="btn btn-info">Edit</a></td>

                            <td><a href="{{ url('user_delete/' . $users->id) }}" style="margin-left: -25px;"
